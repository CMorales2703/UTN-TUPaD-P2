...
public class Ej1 {
    public static void main(String[] args) {
        ...
        // 1. Crear 5 productos
        Producto p1 = new Producto("P001", "Arroz", 500, 50, CategoriaProducto.ALIMENTOS);
        Producto p2 = new Producto("P002", "Notebook", 2500, 10, CategoriaProducto.ELECTRONICA);
        Producto p3 = new Producto("P003", "Remera", 1200, 25, CategoriaProducto.ROPA);
        Producto p4 = new Producto("P004", "Sillón", 8000, 5, CategoriaProducto.HOGAR);
